...
REGION=us-central1
ZONE=us-central1-c
PROJECT_NAME="academic-ivy-370514"
IP_NAME="$PROJECT_NAME-ip"
GOOGLE_ACCOUNT_NAME="gadmicha" # without the @post.bgu.ac.il or @gmail.com part
...
gcloud compute instances delete -q --zone=$ZONE $INSTANCE_NAME
